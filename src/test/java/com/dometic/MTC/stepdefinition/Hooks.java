...
//        System.out.print(PortNumber);
        ...
        cap.setCapability("app", System.getProperty("user.dir") + "/src/test/java/com/dometic/MTC/application/Dometic_Interact_1.6(136).apk");
        String fullReset = prop.getProperty("fullReset_MTC");
        cap.setCapability("fullReset", fullReset);
        try {
            Android_driver = new AndroidDriver(new URL("http://127.0.0.1:6723/wd/hub"), cap);
