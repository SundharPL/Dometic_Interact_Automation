Feature: Verifying application Bilge Pump Screen in Dometic Marine application
  ...
  @First1 @sanity1
  Scenario: Verifying application Bilge Pump(1st Instance) screen UI implementation
...
#    Then I Tap on Back Button
  ...
  @First1 @sanity1
  Scenario: Verifying application Bilge Pump(2nd Instance-FWD Bilge) screen UI implementation
    Then I Tap on Bilge Pump tile on landing screen
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Max Cycle Hour) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Max Cycle Hour) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Max Cycle Hour) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 2nd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Max Daily Cycle) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Max Daily Cycle) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Max Daily Cycle) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 2nd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Continuous) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Continuous) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Alert-Continuous) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 2nd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Max Cycle Hour) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Max Cycle Hour) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Max Cycle Hour) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 2nd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Max Daily Cycle) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Max Daily Cycle)Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Max Daily Cycle) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 2nd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Continuous) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Continuous) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 2nd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(FWD Bilge Warnings-Continuous) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 2nd instance
    Then I Scroll up the page
  ...
  @First1 @sanity1
  Scenario: Verifying application Bilge Pump(3rd Instance-Port Bilge) screen UI implementation
    Then I Tap on Bilge Pump tile on landing screen
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Max Cycle Hour) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Max Cycle Hour) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Max Cycle Hour) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 3rd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Max Daily Cycle) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Max Daily Cycle) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Max Daily Cycle) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 3rd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Continuous) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Continuous) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Alert-Continuous) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 3rd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Warnings-Max Cycle Hour) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Warnings-Max Cycle Hour) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Warnings-Max Cycle Hour) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 3rd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Warnings-Max Daily Cycle) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Warnings-Max Daily Cycle)Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Warnings-Max Daily Cycle) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 3rd instance
    Then I Scroll up the page
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Warnings-Continuous) Carousel boundary maximum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilge Warnings-Continuous) Carousel boundary minimum values Functionality
#    Then I Wait short period for Page to Load
#    Then I Tap on Bilge Pump tile on landing screen
#    Then I Scroll the screen till the 3rd instance
#    Then I Scroll up the page
...
#    Then I Tap on Back Button
  ...
  @sanity1
  Scenario: Verifying application Bilge Pump screen(Port Bilges Warnings-Continuous) Functionality
    Then I Wait short period for Page to Load
    Then I Tap on Bilge Pump tile on landing screen
    Then I Scroll the screen till the 3rd instance
    Then I Scroll up the page
