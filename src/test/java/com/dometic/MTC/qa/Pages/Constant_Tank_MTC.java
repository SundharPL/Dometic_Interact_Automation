...
public class Constant_Tank_MTC {
    ...
    public static final String mtc_Tank_Alerts_Tank_Level_Above_Updated_Value_xpath="(//*[@text='Tank Level Above']//following::android.widget.TextView)[1]";
    ...
    public static final String mtc_Tank_Alerts_Set_Latency_Updated_Value_xpath="(//*[@text='Set Latency']//following::android.widget.TextView)[1]";
    ...
    public static final String mtc_Batteries_Warnings_Tank_Level_Above_Updated_Value_xpath="((//*[@text='Tank Level Above'])[2]//following::android.widget.TextView)[1]";
