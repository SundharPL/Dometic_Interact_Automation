...
public class Constant_BilgePump_MTC {
    ...
    public static final String mtc_Bilge_Pump_Alerts_Max_Cycle_Hour_xpath="(//*[@text='Max Cycles/Hour'])[1]";
    ...
    public static final String mtc_Bilge_Pump_Alerts_Max_Daily_Cycle_xpath="(//*[@text='Max Daily Cycles'])[1]";
    ...
    public static final String mtc_Bilge_Pump_Warnings_Max_Cycle_Hour_xpath="(//*[@text='Max Cycles/Hour'])[2]";
    ...
    public static final String mtc_Bilge_Pump_Warnings_Max_Daily_Cycle_xpath="(//*[@text='Max Daily Cycles'])[2]";
